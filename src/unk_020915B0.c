...
// LoadOVY13/LoadOVY38/UnloadOVY38 are .public but intentionally NOT declared in
// the (frozen, 2-prototype) unk_020915B0.h, which overlay_44_0222CDAC.c is
// byte-matched against. Local forward declarations satisfy MWCC without
// IPA-cascading that file's codegen.
void LoadOVY13(void);
void LoadOVY38(void);
